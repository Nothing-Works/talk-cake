 ...
 * Generated for Laravel 5.7.26 on 2019-02-16 07:33:07.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
        ...
        {
            return \Illuminate\Contracts\Auth\Guard::check();
        }
        ...
        {
            return \Illuminate\Contracts\Auth\Guard::guest();
        }
        ...
        {
            return \Illuminate\Contracts\Auth\Guard::id();
        }
        ...
        {
            return \Illuminate\Contracts\Auth\Guard::validate($credentials);
        }
        ...
        {
            \Illuminate\Contracts\Auth\Guard::setUser($user);
        }
        ...
        {
            return \Illuminate\Contracts\Auth\StatefulGuard::attempt($credentials, $remember);
        }
        ...
        {
            return \Illuminate\Contracts\Auth\StatefulGuard::once($credentials);
        }
        ...
        {
            \Illuminate\Contracts\Auth\StatefulGuard::login($user, $remember);
        }
        ...
        {
            return \Illuminate\Contracts\Auth\StatefulGuard::loginUsingId($id, $remember);
        }
        ...
        {
            return \Illuminate\Contracts\Auth\StatefulGuard::onceUsingId($id);
        }
        ...
        {
            return \Illuminate\Contracts\Auth\StatefulGuard::viaRemember();
        }
